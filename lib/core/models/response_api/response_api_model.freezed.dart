...
abstract class $ResponseApiModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? state, String? message, dynamic data});
}
...
class _$ResponseApiModelImpl implements _ResponseApiModel {
  const _$ResponseApiModelImpl({this.state = "", this.message = "", this.data});
  ...
  @override
  String toString() {
    return 'ResponseApiModel(state: $state, message: $message, data: $data)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, state, message, const DeepCollectionEquality().hash(data));
